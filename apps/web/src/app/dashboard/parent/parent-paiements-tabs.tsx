...
type ParentPaiementsTabsProps = {
  activeTab: "en-cours" | "historique";
  pendingCount: number;
  historyCount: number;
};

export function ParentPaiementsTabs({
  activeTab,
  pendingCount,
  historyCount,
}: ParentPaiementsTabsProps) {
  ...
  return (
    <nav className="flex flex-wrap gap-2" aria-label="Paiements parent">
